...
(lambda (x y z) (cons (+ x y) z))
; expect (lambda (x y z) (cons (+ x y) z))

; define special form
(define g (lambda (x y z) (cons (+ x y) z)))
; expect g
(g 1 2 3)
; expect (3 . 3)
...
; test cond
(cond ((null? ()) '(My soul is as empty as this list))
     (else '(not empty)))
; expect (my soul is as empty as this list)
...
; test mu
(define m (mu () (+ (* 1000 a) (+ b c))))
; expect m
(define l1 (lambda () (define a 2) (define b 9) (define c 9) (m)))
; expect l1
(l1)
; expect 2018
(define l2 (lambda () (define a 2) (define c 9) (m)))
; expect l2
(l2)
; expect Error
